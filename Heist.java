...
public class Heist
{
    ...
    ,"You are standing in a very dirty and smelly sewer. to your left you see an incredibly deep shaft for \n transferring waste water from the surface sewer to a deeper part of the sewer you can’t \n even make out the bottom, to your right is a very small shaft maybe a little wider than your torso looking ahead there is a huge river of waste that is wide enough you are sure you cannot cross it without getting caught in the current. "
    ...
    while(gameRunning){
        ...
        System.out.println("You've already started the game");
        continue;
        }}
